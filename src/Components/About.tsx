...
import Balaji2 from "../assets/balaji_image_2.jpeg";
import Balaji3 from "../assets/balaji-3.jpeg";
import Balaji4 from "../assets/balaji-4.jpeg";
import Balaji5 from "../assets/balaji_image_cut.jpeg";
    ...
    <>
      <div className="p-home-page-content-container">
        ...
        <div>
          ...
          <div className="p-home-page-image-con">
            <div className="p-home-page-image-container">
                <img src={Balaji2} alt="" className="p-home-page-personal-image" />
            </div>
        </div>
            <div className="p-home-page-image-con">
              <div className="p-home-page-image-container">
                  <img src={Balaji3} alt="" className="p-home-page-personal-image" />
              </div>
          </div>
          <div className="p-home-page-image-con">
            <div className="p-home-page-image-container">
                <img src={Balaji4} alt="" className="p-home-page-personal-image" />
            </div>
        </div>
          <div className="p-home-page-image-con">
            <div className="p-home-page-image-container">
                <img src={Balaji5} alt="" className="p-home-page-personal-image" />
            </div>
        </div>
      </div>
    </>
